...
class AccountMoveReversal(models.TransientModel):
    ...
    def reverse_moves(self):
        ...
        for refund in self.new_move_ids:
            ...
            provider_id = self.move_ids.transaction_ids.provider_id \
                if self.move_ids.transaction_ids else None
            product_id = self.env['product.product'].browse(
                provider_id.payment_fee_product_id.id) if provider_id else None
            if product_id:
